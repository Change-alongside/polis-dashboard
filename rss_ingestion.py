...
PRESIDENT_KEYWORDS = {
    "Algeria": ["tebboune"], "Egypt": ["sisi", "el-sisi"],
    "Libya": ["menfi", "dbeibah"], "Morocco": ["mohammed vi", "king mohammed"],
    "Sudan": ["al-burhan", "burhan"], "Tunisia": ["saied"],
    "Benin": ["talon"], "Burkina Faso": ["traore"],
    "Cape Verde": ["neves"], "Cote d Ivoire": ["ouattara"],
    "Gambia": ["barrow"], "Ghana": ["mahama"],
    "Guinea": ["doumbouya"], "Guinea-Bissau": ["embalo"],
    "Liberia": ["boakai"], "Mali": ["goita"],
    "Mauritania": ["ghazouani"], "Niger": ["tchiani"],
    "Nigeria": ["tinubu"], "Senegal": ["faye"],
    "Sierra Leone": ["bio"], "Togo": ["gnassingbe"],
    "Angola": ["lourenco"], "Cameroon": ["biya"],
    "Central African Republic": ["touadera"], "Chad": ["deby"],
    "DRC": ["tshisekedi"], "Equatorial Guinea": ["nguema"],
    "Gabon": ["oligui"], "Republic of Congo": ["sassou"],
    "Sao Tome and Principe": ["vila nova"], "Burundi": ["ndayishimiye"],
    "Comoros": ["assoumani"], "Djibouti": ["guelleh"],
    "Eritrea": ["afwerki"], "Ethiopia": ["abiy"],
    "Kenya": ["ruto"], "Madagascar": ["randrianirina"],
    "Malawi": ["mutharika"], "Mauritius": ["gokhool"],
    "Mozambique": ["chapo"], "Rwanda": ["kagame"],
    "Seychelles": ["ramkalawan"], "Somalia": ["mohamud"],
    "South Sudan": ["kiir"], "Tanzania": ["samia", "hassan"],
    "Uganda": ["museveni"], "Botswana": ["boko"],
    "Eswatini": ["mswati"], "Lesotho": ["lerotholi"],
    "Namibia": ["mbumba"], "South Africa": ["ramaphosa"],
    "Zambia": ["hichilema"], "Zimbabwe": ["mnangagwa"],
}
